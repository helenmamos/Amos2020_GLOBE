...
# 01 Aug 2019 - MJ Starke - v1.0 created
# 17 Oct 2019 - HM Amos   - Colors for GLOBE Observer protocols added
#
# CITATION
...
std_colors = {
    ...
    # Colors for comparisons between protocols
    # Added by HM Amos 2019-10-18
    "sky_conditions": "deepskyblue", 
    "land_covers": "darkgreen", 
    "mosquito_habitat_mapper": "firebrick", 
    "tree_heights": "yellowgreen",
...
print('Success: run figure_common')